...
vim.keymap.set("n", "<leader>q", ":bdel<CR>", { silent = true })
...
require("nvim-treesitter.configs").setup({
	...
	ensure_installed = { "javascript", "c", "cpp", "go", "lua", "python", "rust", "typescript", "help" },
	auto_install = true,
...
local servers = { "pyright", "cssls", "html", "sumneko_lua", "denols" }
